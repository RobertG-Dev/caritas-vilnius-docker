...
docker compose exec wp wp-cli core install --url="http://localhost:8383" --title="Caritas-Vilnius" --admin_user="robertas" --admin_email="robertas.grajevskis@gmail.com"
